...
public class MovieListingApp extends AppHelper {
	...
	/**
	 * Remove an existing Movie from listing by setting its showing status to
	 * End_Of_Showing.
	 */
	//// (4) DELETE LISTING
	public void removeMovie() {
		...
		try {
			...
			/*
			 * // Delete movie .dat file if(movieFiles[indexToUpdate].delete()) {
			 * System.out.println("------- SUCCESSFULLY DELETED MOVIE LISTING -------\n");
			 * 
			 * // Reload movies this.load();
			 * 
			 * runInterface(); } else {
	 ...
	 */
	// view the top five by ranking movies by TicketSales and Overall reviewers'
	// rating
